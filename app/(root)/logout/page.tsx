...
const page = () => {
    return ( 
        <main className="fixed h-dvh w-full bg-black/80 flex items-center justify-center z-10 top-0 left-0">
            <div className="relative w-[90%] sm:w-[70%] md:w-[50%] lg:w-[40%] xl:w-[30%] h-[15rem] bg-white p-4 md:p-8 rounded-xl">
                <div className="flex flex-col gap-y-5 xl:gap-y-3 items-center justify-center text-center">
                    ...
                    <form action={logOut} className='flex justify-between w-full'>
                        <Link href='/dashboard' className='px-4 md:px-6 xl:px-8 bg-generalBlue dark:bg-cloudBlue hover:bg-cloudBlue dark:hover:bg-generalBlue text-white py-3 rounded-[2rem] duration-300'>Go home</Link>
